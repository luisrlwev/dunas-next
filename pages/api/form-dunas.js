...
const handler = async (req, res) => {
  ...
  const { nombre, email, tel, tipo, inversion, tipologias, condiciones, fechaEnvio, horaEnvio, paginaEnvio, formularioOrigen } = req.body;

  let subjectLine = 'Dunas';
  if (formularioOrigen) {
